$(document).ready(function(){
    ...
    window.onload=function(){	
        var el       = document.querySelector('.home .main_title .type')
        var options  = {
    ...
    $(window).on('scroll', function(){
        ...
        if( $('section.pc').hasClass('active') || $('section.responsive').hasClass('active')){
            $('#wrap').removeClass('dark');
            $('#wrap').removeClass('project');
            $('#wrap').addClass('bright');

        } else if( $('section.project').hasClass('active') ) {
            $('#wrap').removeClass('bright');
            $('#wrap').removeClass('dark');
            $('#wrap').addClass('project');
